...
if __name__ == '__main__':
    ...
    #                                       list_path='dataset/')
    # 创建UrbanSound8K数据列表
    create_UrbanSound8K_list(audio_path='/openbayes/input/input0/UrbanSound8K/audio',
            metadata_path='/openbayes/input/input0/UrbanSound8K/metadata/UrbanSound8K.csv',
                             list_path='/openbayes/home/AudioClassification-Pytorch')
